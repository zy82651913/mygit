...
/**
 * Servlet implementation class ServletBanBao_table
 */
@WebServlet("/ServletBanBao_table")
public class ServletBanBao_table extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletBanBao_table() {
        super();
